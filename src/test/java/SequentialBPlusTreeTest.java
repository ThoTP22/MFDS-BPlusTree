...
public class SequentialBPlusTreeTest {
    ...
    private static void compareConstructionMethods() {
        ...
        long topDownTime = Timer.get("top-down-construction");
        long bottomUpTime = Timer.get("bottom-up-construction");
        long topDownSearchTime = Timer.get("top-down-search-test");
        long bottomUpSearchTime = Timer.get("bottom-up-search-test");
    ...
    private static void saveTreeReport(BPlusTree tree, String method, long constructionTime, int dataSize, boolean includeCache) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(reportFile))) {
            ...
            long searchTime = Timer.get(method + "-search-test");
